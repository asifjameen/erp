						...
						<div class="card-body form-group form-group-sm">
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										<input type="text" class="form-control margin-bottom copy-input " required="" name="customer_address_1" id="customer_address_1" placeholder="Company_name" tabindex="3">	
									</div>
									...
									<div class="form-group">
										<input type="text" class="form-control margin-bottom copy-input " required="" name="customer_town" id="customer_town" placeholder="GST_NO" tabindex="5">		
									</div>
								...
								<div class="col-md-6">
									<div class="input-group float-right margin-bottom">
										...
										<input type="text" class="form-control copy-input " required="" name="customer_email" id="customer_email" placeholder="Customer_id" aria-describedby="sizing-addon1" tabindex="2">
									</div>
								    
								    <div class="form-group">
								    	<input type="text" class="form-control margin-bottom copy-input " required="" name="customer_address_2" id="customer_address_2" placeholder="address" tabindex="6">
								    </div>
					...
					<div class="card card-default">
						...
						<div class="card-body form-group form-group-sm">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<select id="transport_name" class="form-select form-control margin-bottom " required="" name="transport_name" placeholder="Transport_name" tabindex="15">
                                                                        ...
                                                                        foreach ($rows as $row) {
                                                                        ?&gt;
                                                                        <option value="<?php echo $row['id'];?>"><!--?php echo $row['transportName'];?--></option>
								...
								<!--	<div class="form-group">
										<input type="text" class="form-control margin-bottom" name="weight" id="weight" placeholder="Weight" tabindex="16">	
																	...
																	-->
									<div class="form-group no-margin-bottom">
										<input type="text" class="form-control " required="" name="bags" id="bags" placeholder="bags" tabindex="17">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
								    	<input type="text" class="form-control margin-bottom " required="" name="ewaysno" id="ewaysno" placeholder="E-Way_no" tabindex="18">
									</div>
									<div class="form-group">
										<input type="text" class="form-control margin-bottom " required="" name="destination" id="destination" placeholder="Destination" tabindex="19">							
								    </div>
			...
			<!-- / end client details section -->
			 <div class="table-responsive">
				...
				<thead>
					<tr>
						<th width="">
							<h4><a href="#" class="btn btn-success btn-xs add-row"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a> Products</h4>
						</th>
						<th>
							<h4>AVL_Qty</h4>
						</th>
					...
					<tr class="sub-row">
						<td>
							<div class="form-group  no-margin-bottom">
								...
								<input type="text" class="form-control item-input invoice_product" required="" name="invoice_product[]" placeholder="Enter Product Name OR Description">
								<p class="item-select">or <a href="#">select a product</a></p>
								<div>
									<br>
									<input type="button" value="Del" name="ss" id="ss" class="btn btn-danger btn-xs delete-row">
									<input type="button" value="Add_pro" name="ss" id="add-row" class="btn btn-primary btn-xs add-row">
						</div>
   ...
   <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
						...
						<td class="text-right">
							<div class="input-group input-group-sm  no-margin-bottom">
								...
								<input type="number" class="form-control calculate invoice_product_price " name="invoice_product_price[]" aria-describedby="sizing-addon1" placeholder="0.00">
							</div>
						</td>
						<td class="text-right">
							<div class="form-group form-group-sm  no-margin-bottom">
								<input type="text" class="form-control calculate" name="invoice_product_discount[]" value="0" placeholder="Enter % OR value (ex: 10% or 10.50)">
							</div>
						</td>
						<td class="text-right">
							<div class="input-group input-group-sm">
								<span class="input-group-addon"><!--?php echo CURRENCY ?--></span>
								<input type="text" class="form-control subbb calculate-sub" name="invoice_product_sub[]" id="invoice_product_sub" value="0.00" aria-describedby="sizing-addon1">
							</div>
						</td>
					</tr>
				</tbody>
					...
					<div class="row">
						<div class="col-md-4 col-md-offset-5">
							...
							<div class="input-group input-group-sm">
								...
								<input type="text" class="form-control calculate shipping mb-2" name="invoice_shippping" aria-describedby="sizing-addon1" placeholder="0.00">
							</div>
						</div>
					</div>
					<div class="row tax">
