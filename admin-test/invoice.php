    ...
    <div class="row">
        ...
        <div class="col-md-8 text-right">
            <div class="row">
                ...
                <div class="col-6">
                    <input type="text" name="invoice_id" id="invoice_id" class="form-control " placeholder="Invoice Number" aria-describedby="sizing-addon1" value="">
                </div>
            ...
            <div class="card ">
                ...
                <div class="card-body form-group form-group-sm mb-0 p-2">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control margin-bottom copy-input " name="customer_name" id="customer_name" placeholder="Enter Name" tabindex="1">
                            </div>

                            <div class="form-group">
                                <input type="text" class="form-control margin-bottom copy-input " name="customer_address_1" id="customer_address_1" placeholder="Company_name" tabindex="3">
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control margin-bottom copy-input " name="customer_town" id="customer_town" placeholder="GST_NO" tabindex="5">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-group float-right mb-4">
                                ...
                                <input type="text" class="form-control copy-input " name="customer_email" id="customer_email" placeholder="Customer_id" aria-describedby="sizing-addon1" tabindex="2">
                            </div>

                            <div class="form-group">
                                <input type="text" class="form-control margin-bottom copy-input " name="customer_address_2" id="customer_address_2" placeholder="address" tabindex="6">
                            </div>
                            <div class="form-group no-margin-bottom">
                                <input type="text" class="form-control " name="customer_phone" id="customer_phone" placeholder="Phone Number" tabindex="8">
                            </div>
            ...
            <div class="card card-default">
                ...
                <div class="card-body form-group mb-0">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type='text' id="transport_name" class="form-select form-control margin-bottom " name="transport_name" placeholder="Transport_name" tabindex="15">
                            ...
                            <!--	<div class="form-group">
										<input type="text" class="form-control margin-bottom" name="weight" id="weight" placeholder="Weight" tabindex="16">	
																	...
																	-->
                            <div class="form-group no-margin-bottom">
                                <input type="text" class="form-control " name="bags" id="bags" placeholder="bags" tabindex="17">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control margin-bottom " name="ewaysno" id="ewaysno" placeholder="E-Way_no" tabindex="18">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control margin-bottom " name="destination" id="destination" placeholder="Destination" tabindex="19">
                            </div>
...
<div class="row tax">
    ...
    <div class="col-8 margin-bottom">
        <div class="input-group input-group-sm">
            <span class="input-group-addon">₹</span>
            <input type="text" class="form-control calculate_cgst" id="invoice_sgst" name="invoice_sgst" placeholder="0.00">
        </div>
    </div>
</div>
<div class="row tax">
    ...
    <div class="col-8">
        <div class="input-group input-group-sm margin-bottom">
            <span class="input-group-addon">₹</span>
            <input type="text" class="form-control calculate_cgst" id="invoice_cgst" name="invoice_cgst" placeholder="0.00">
        </div>
    </div>
</div>
<div class="row">
